...
import { dogFoodProducts } from "../../Products/DogFood/DogFoodObj";
...
export default function FeaturedProducts() {
  ...
  // Har slide me 3 products
  const groupedProducts = [];
  for (let i = 0; i < dogFoodProducts.length; i += 3) {
    groupedProducts.push(dogFoodProducts.slice(i, i + 3));
  }
