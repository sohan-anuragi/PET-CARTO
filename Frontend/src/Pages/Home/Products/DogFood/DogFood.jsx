...
import { dogFoodProducts } from "./DogFoodObj";
import { catDollersProducts } from "../CatDollers/CatDollersData";
import { petToysProducts } from "../PetToys/PetToysData";

const DogFood = ({ selectedCategory }) => {
  ...
  let activeData = dogFoodProducts;
  if (selectedCategory === "CatDollers") {
    activeData = catDollersProducts;
  }
  if (selectedCategory === "PetToy") {
    activeData = petToysProducts;
  }
