...
import DogFood from "../../../../Pages/Home/Products/DogFood/DogFood";
...
export default function Products() {
  ...
  return (
    <div className="mt-[-1.5rem] rounded-lg bg-white  shadow-lg">
      <div className="m-[1rem] border-b-[1px] flex-col items-center border-gray-300 flex sm:justify-between gap-6 sm:flex-row">
        ...
        <div className="flex pt-[0.7rem] items-center justify-center gap-3 mb-4">
          <button
            type="button"
